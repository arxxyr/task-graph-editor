...
```bash
uv run --no-project python scripts/release_notes.py --tag v0.12.0
...
| 平台 | 文件名 |
|------|--------|
| Linux x64 | `task-graph-editor-v0.12.0+{commit}-linux-x64.tar.gz` |
| macOS ARM64 | `task-graph-editor-v0.12.0+{commit}-macos-arm64.zip`（应用包） |
| Windows x64 | `task-graph-editor-v0.12.0+{commit}-windows-x64.zip` |
